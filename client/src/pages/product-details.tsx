          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-4" data-testid="text-product-title">
                {product.deal_description || product.title || `${product.MakeName} ${product.GradeName}`.trim() || 'Product Details'}
              </h1>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground leading-relaxed" data-testid="text-description">
                  {product.deal_description || product.description || 'No description available'}
                </p>
              </CardContent>
            </Card>
